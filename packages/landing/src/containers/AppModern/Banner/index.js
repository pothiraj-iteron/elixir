      ...
      <Container>
        <BannerContent>
          ...
          <Fade up delay={100}>
            <Heading
              as="h1"
              content="We love what we do and we 
          ...
          <Fade up delay={200}>
            <Text
              content="ELIXIREXPERTS is a Brand of ITERON Group with key focus on Custom built solutions based on new technologies like Elixir, 
              Reactjs, Nodejs. The Company was formed by 4 Directors from different continents coming with more 20+ years of experience in outsourcing indutry."
            />
          </Fade>
          <Fade up delay={300}>
            <ButtonGroup>
