...
var Accordion = /*#__PURE__*/React.forwardRef(function Accordion(_ref, forwardedRef) {
  ...
  return React__default['default'].createElement(descendants.DescendantProvider, {
    ...
    items: descendants$1,
    set: setDescendants
  }, React__default['default'].createElement(AccordionContext.Provider, {
    value: context
...
var AccordionItem = /*#__PURE__*/utils.forwardRefWithAs(function AccordionItem(_ref2, forwardedRef) {
  ...
  return React__default['default'].createElement(AccordionItemContext.Provider, {
    value: context
...
var AccordionButton = /*#__PURE__*/utils.forwardRefWithAs(function AccordionButton(_ref3, forwardedRef) {
  ...
  return React__default['default'].createElement(Comp // Each accordion header `button` is wrapped in an element with role
